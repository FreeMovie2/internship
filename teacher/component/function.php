<?php
    ...
    function AlertBox(){
        ...
        }elseif(isset($_GET['status']) && $_GET['status'] == 'error_import'){
            echo '<div class="callout callout-danger mb-3">
                    รองรับเฉพาะสกุลไฟล์ .csv (UTF-8) !        
            </div>';
        }elseif(isset($_GET['status']) && $_GET['status'] == 'error_password'){
            echo '<div class="callout callout-danger mb-3">
                    Password ไม่ถูกต้อง !        
            </div>';
        }elseif(isset($_GET['status']) && $_GET['status'] == 'error_file'){
            echo '<div class="callout callout-danger mb-3">
                     รองรับเฉพาะไฟล์สกุล (.pdf, .jpg, .jpeg, .png) !       
            </div>';
        }elseif(isset($_GET['status']) && $_GET['status'] == 'duplicate_username'){
            echo '<div class="callout callout-danger mb-3">
