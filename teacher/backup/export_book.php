                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-12 mb-3">
                                ...
                                <p class="text-center"><img src="../student_internship/uploaded/internship_img/<?php echo $fetch_weekly2['i_img1']; ?>" class="img-fluid w-75"/></p>
                                <p class="text-justify mt-1"><b>รายละเอียด : </b><?php echo $fetch_weekly2['i_img1_detail']; ?></p>

                                <p class="text-center"><img src="../student_internship/uploaded/internship_img/<?php echo $fetch_weekly2['i_img2']; ?>" class="img-fluid w-75 mt-3"/></p>
