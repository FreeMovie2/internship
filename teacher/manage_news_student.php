        ...
        <main class="app-main">
            ...
            <div class="app-content-header">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <h3 class="mb-0">บริหารจัดการข่าวสารนักเรียน</h3>
                        </div>
                                    ...
                                    <table id="myTable" class="display">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="news.php?news_id=<?php echo $fetch_news['n_id']; ?>" class="btn btn-info w-100"><i class="bi bi-newspaper"></i> อ่านข่าว</a></td>
                                                <td>
                                                    <form method="post" action="process/edit_news_student.php" enctype="multipart/form-data">
                                                            <input type="text" name="n_author" value="<?php echo $_SESSION['t_id'];?>" class="d-none" readonly>
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="mb-3 mt-3">
                                                                                    ...
                                                                                    <?php }else{ ?>
                                                                                        <a href="../student_internship/uploaded/news_resources/<?php echo $fetch_news['n_pic'];?>" class="btn btn-sm btn-primary" target="_blank">ดูไฟล์ที่อัพโหลด</a>
                                                                                    <?php } ?>
                                                                                    <input
                                                                                        type="file"
                                                                                        class="form-control"
                                                ...
                                                <td>
                                                    <form method="post" action="process/delete_news_student.php">
