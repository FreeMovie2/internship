<?php
    ...
    if(!isset($_SESSION['t_id'])){
        ...
        $sql_chceker = $conn->prepare("SELECT * FROM company WHERE c_advice = ? ");
        ...
        <main class="app-main"> <!--begin::App Content Header-->
            <div class="app-content-header"> <!--begin::Container-->
                <div class="container-fluid"> <!--begin::Row-->
                    <div class="row">
                        <div class="col-sm-6">
                            <h3 class="mb-0">บริหารจัดการนักเรียนในที่ปรึกษา</h3>
                        </div>
                        ...
                        <div class="col-lg-12 connectedSortable">
                            <div class="card mb-4">
                                <div class="card-header">
                                    <h3 class="card-title">บริหารจัดการนักเรียนในที่ปรึกษา</h3>
                                </div>
                                <div class="card-body">
                                    <?php
                                        AlertBox();
                                        ...
                                        <tbody>
                                            ...
                                            <?php while($fetch_checker = $result_checker->fetch_assoc()){ ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                    <form method="post" action="process/delete_student_advisor.php">
