            ...
            <div class="subpage">
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <?php if(NumFetchTeacherComment($_SESSION['s_id'],$week_ref,$conn) == 0) {?>
                        <div class="col-7">
                        ...
                        <div class="col-7">
                            ...
                            <p>บันทึกครูนิเทศ : <?php echo FetchTeacherComment($_SESSION['s_id'],$week_ref,$conn); ?> </p>
                            <p class="text-center mt-3">
                                ลงชื่อ...........................................ครูนิเทศ
                            </p>
                            <p class="text-center">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-12 mb-3">
                                ...
                                <p class="text-center"><img src="uploaded/internship_img/<?php echo $fetch_weekly2['i_img1']; ?>"  style="max-width:500px; max-height:300px; display:block; margin:0 auto;"/></p>
                                <p class="text-justify mt-1"><b>รายละเอียด : </b><?php echo $fetch_weekly2['i_img1_detail']; ?></p>

                                <p class="text-center"><img src="uploaded/internship_img/<?php echo $fetch_weekly2['i_img2']; ?>"  style="max-width:500px; max-height:300px; display:block; margin:0 auto;"/></p>
