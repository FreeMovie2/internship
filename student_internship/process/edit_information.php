<?php
    ...
    if(isset($_POST['submit']) && $_SERVER["REQUEST_METHOD"] == "POST"){
        $uploadDir = "../information_file/profile/"; 
        ...
        if(!in_array($ext, $allowed)){
            header("location:../edit_information.php?status=error_img");
        }else{
            if (!is_dir($uploadDir)) {
            ...
            if($sql_student->execute()){
                ...
                if($sql_student_information->execute()){
                    ...
                    if (!$delete_subjects) {
                        header("Location:../edit_information.php?status=error");
                        exit();
                    }
                    ...
                    header("Location:../edit_information.php?status=success");
                }else{
                    header("Location:../edit_information.php?status=error");
                }
