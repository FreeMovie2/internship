<?php
    ...
    if(!isset($_SESSION['s_id'])){
        ...
        $sql_teacher = $conn->prepare("SELECT * FROM teachers WHERE t_id != 1");
        $sql_teacher->execute();
        $result_teacher = $sql_teacher->get_result();

        $sql_teacher2 = $conn->prepare("SELECT * FROM teachers WHERE t_id != 1");
...
.form-section-body.form-grid > .mb-3,
.form-section-body.form-grid > .form-group {
    margin-bottom: 0 !important;
}

.form-section-body.form-grid > .full-width {
    grid-column: 1 / -1;
}
...
<body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="process/edit_company.php" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            ?>
                                            <br />
                                            <img src="information_file/company/<?php echo $fetch_company['c_map']; ?>"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            ?>
                                            <br />
                                            <img src="information_file/company/<?php echo $fetch_company['c_org']; ?>"
                                                class="img-fluid w-25 mb-3" />
                                        ...
                                        <div class="custom-select-container">
                                            <button class="form-select text-start" id="customSelectButton2"
                                                type="button">
                                                <?php
                                                    if(is_null($fetch_company['c_advice2'])){
                                                ?>
                                                    เลือกชื่อครูนิเทศ
                                                <?php }else{ ?>
                                                    <?php
                                        ...
                                        <div class="mb-3">
                                            ...
                                            value="<?php echo ConvertToThaiDateSplit3($fetch_company['c_start']); ?>">
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            value="<?php echo ConvertToThaiDateSplit3($fetch_company['c_end']); ?>">
                                        </div>
    ...
    <script>
        (function () {
            const form = document.querySelector('form[action="process/edit_company.php"]');
            if (!form) {
                return;
            }
            ...
            const sectionBodies = form.querySelectorAll('.form-section-body');
            ...
            const phoneInputs = form.querySelectorAll('input[name="c_tel"], input[name="c_tel2"]');
