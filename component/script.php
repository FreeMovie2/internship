...
<script>
    ...
    $('.buddhist-date-picker').each(function () {
        var $this = $(this);
        var dateValue = $this.val(); // Get current value from the input field
        ...
        // Update the datepicker value (if the input has a predefined value)
        var parsedDate = parseThaiDate(dateValue);
        $this.datepicker('update', parsedDate ? parsedDate : new Date());
    });
});
